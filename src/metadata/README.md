 ...
 * [rehabo.yml](rehabo.yml)
     * Determines how your purl.obolibrary.org/obo/rehabo/ redirects will be handled
     ...
     * Paste in the contents of [rehabo.yml](rehabo.yml)
 ...
 * [rehabo.md](rehabo.md)
     ...
     * Paste in the contents of [rehabo.md](rehabo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
